...
class EventController extends Controller
{
    ...
    public function show(Request $request): Renderable
    {
        ...
        $event->arrayTest = collect([
                ["x" => 0, "y" => 0, "w" => 2, "h" => 2, "i" => "0", "status" => 0],
                ["x" => 2, "y" => 0, "w" => 2, "h" => 3, "i" => "1","status" => 1],
                ["x" => 4, "y" => 0, "w" => 2, "h" => 3, "i" => "2", "status" => 2],
                ["x" => 6, "y" => 0, "w" => 2, "h" => 3, "i" => "3"],
                ["x" => 8, "y" => 0, "w" => 2, "h" => 3, "i" => "4"],
                ...
                ["x" => 2, "y" => 5, "w" => 2, "h" => 3, "i" => "7"],
                ["x" => 4, "y" => 5, "w" => 2, "h" => 3, "i" => "8"],
                ["x" => 6, "y" => 5, "w" => 2, "h" => 3, "i" => "10"],
                ["x" => 8, "y" => 5, "w" => 2, "h" => 3, "i" => "11"],
                ["x" => 10, "y" => 5, "w" => 2, "h" => 3, "i" => "12"],
                ["x" => 0, "y" => 10, "w" => 2, "h" => 3, "i" => "13"],
                ["x" => 2, "y" => 10, "w" => 2, "h" => 3, "i" => "14"],
                ["x" => 4, "y" => 10, "w" => 2, "h" => 3, "i" => "15"],
                ["x" => 6, "y" => 10, "w" => 2, "h" => 3, "i" => "16"],
                ["x" => 8, "y" => 10, "w" => 2, "h" => 3, "i" => "17"],
                ["x" => 10, "y" => 10, "w" => 2, "h" => 3, "i" => "18"],
                ["x" => 0, "y" => 15, "w" => 2, "h" => 3, "i" => "19"],
                ["x" => 2, "y" => 15, "w" => 2, "h" => 3, "i" => "20"]
            ]);
